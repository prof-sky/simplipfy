function getExplanation(values) {
    let voltSym = languageManager.currentLang.voltageSymbol;
    let str = "";
    str += `<h5 class="text-center">${languageManager.currentLang.wheatstoneExplanationTitle}</h5>`;
...
function r1Explanation(values) {
    ...
    let uq = languageManager.currentLang.voltageSymbol + "q";
    let um = languageManager.currentLang.voltageSymbol + "m";
    ...
    let str = `<h5>${languageManager.currentLang.rearrangeFor} R1</h5>`;
    str += `<div class="text-center">
...
function r2Explanation(values) {
    ...
    let uqVal = values.Uq + "V";
    let umVal = values.Um + "V";
    let str = `<h5>${languageManager.currentLang.rearrangeFor} R2</h5>`;
    str += `<div class="text-center">
                <p class="mb-1">$$\\frac{${um}}{${uq}} = \\frac{R2}{R1+R2} - \\frac{R4}{R3+R4}$$</p>
                <p class="mb-1">$$\\frac{R2}{R1+R2} = \\frac{${um}}{${uq}} + \\frac{R4}{R3+R4}$$</p>
...
function r3Explanation(values) {
    ...
    let uqVal = values.Uq + "V";
    let umVal = values.Um + "V";
    let str = `<h5>${languageManager.currentLang.rearrangeFor} R3</h5>`;
    str += `<div class="text-center">
                <p class="mb-1">$$\\frac{${um}}{${uq}} = \\frac{R2}{R1+R2} - \\frac{R4}{R3+R4}$$</p>
...
function r4Explanation(values) {
    ...
    let uqVal = values.Uq + "V";
    let umVal = values.Um + "V";
    let str = `<h5>${languageManager.currentLang.rearrangeFor} R4</h5>`;
    str += `<div class="text-center">
                <p class="mb-1">$$\\frac{${um}}{${uq}} = \\frac{R2}{R1+R2} - \\frac{R4}{R3+R4}$$</p>
                <p class="mb-1">$$\\frac{R4}{R3+R4} = \\frac{R2}{R1+R2} - \\frac{${um}}{${uq}}$$</p>
...
function twoResistorsUnknownExplanation(values) {
    ...
    if (values.Um === 0) {
        str += "<div class='text-center'>";
        str += languageManager.currentLang.wheatstoneBridgeVoltage0;
...
function relationFormula(values) {
    ...
    let voltSym = languageManager.currentLang.voltageSymbol;
    let str = languageManager.currentLang.wheatstoneBridgeVoltage0;
    str += `<div class="text-center">
