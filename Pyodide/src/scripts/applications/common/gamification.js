...
function addSpeedModeTimeBar(duration, onComplete) {
    ...
    div.style.backgroundColor = colors.keyYellow;
    ...
    function animate(now) {
        ...
        if (timeLeft <= 2750) {
            ...
            state.speedMode.div.style.backgroundColor = isRed ? "#ff3333" : colors.keyYellow;
        } else {
            state.speedMode.div.style.backgroundColor = colors.keyYellow;
        }
    }
