dataPrivacyDeTexts = {
    dataPrivacyBody: `<h1>Datenschutz&shy;erkl&auml;rung</h1>
        ...
        dieser Website ist:</p> <p>Prof. Dr. Stefan Kray<br />
        Hochschule Pforzheim<br />
        Tiefenbronner Str. 65<br />
        75175 Pforzheim</p>
        <p>Telefon: +49 (0) 7231/28-6621<br />
            E-Mail: info@simplipfy.org</p>
        ...
        <h3>Lokaler Speicher</h3> <p>Diese Website speichert technisch notwendige Informationen im lokalen Speicher ihres Browsers.
        Diese Informationen werden nicht an Dritte weitergegeben, nicht von uns abgefragt oder auf unserem Server gespeichert.</p>
        ...
        <h3>Matomo</h3> <p>Diese Website benutzt den Open Source Webanalysedienst Matomo.</p> <p>Mit Hilfe von
        Matomo sind wir in der Lage Daten &uuml;ber die Nutzung unserer Website durch die Websitebesucher zu erfassen
        und zu analysieren. Hierdurch k&ouml;nnen wir u.&nbsp;a. herausfinden, wann welche Seitenaufrufe get&auml;tigt
        wurden und aus welcher Region sie kommen. Au&szlig;erdem erfassen wir verschiedene Logdateien (z.&nbsp;B. IP-
        Adresse, Referrer, verwendete Browser und Betriebssysteme) und k&ouml;nnen messen, ob unsere
        Websitebesucher bestimmte Aktionen durchf&uuml;hren (z.&nbsp;B. Klicks, K&auml;ufe u. &Auml;.).</p> <p>Die
        ...
        <h4>IP-Anonymisierung</h4> <p>Bei der Analyse mit Matomo setzen wir IP-Anonymisierung ein. Hierbei wird Ihre
        IP-Adresse vor der Analyse gek&uuml;rzt, sodass Sie Ihnen nicht mehr eindeutig zuordenbar ist.</p>
        <h4>Cookielose Analyse</h4> <p>Wir haben Matomo so konfiguriert, dass Matomo keine Cookies in Ihrem
        Browser speichert.</p>
...
noreferrer">https://policies.google.com/privacy?hl=de</a>.</p>
        <h3>Bootstrap (lokales Hosting)</h3><p>Diese Seite nutzt das Framework Bootstrap. Bootstrap ist lokal installiert und eine Verbindung zu weiteren Servern findet nicht statt.</p>
        <p>Weitere Informationen zu Bootstrap finden Sie unter <a href="https://getbootstrap.com/" target="_blank" rel="noopener noreferrer">https://getbootstrap.com/</a></p>
        <h3>Canvas-Confetti (lokales Hosting)</h3>
        <p>Diese Seite nutzt des weiteren auch das Paket Canvas-Confetti. Auch hier wird auf eine lokal installierte Version zurückgegriffen und
        keine Verbindung zu anderen Servern hergestellt.</p>
        <p>Weitere Informationen zu Canvas-Confetti finden Sie unter <a href="https://github.com/catdad/canvas-confetti#readme" target="_blank" rel="noopener noreferrer">https://github.com/catdad/canvas-confetti#readme</a></p>
        
        <h3>Circuit Sandbox (lokales Hosting)</h3>
        <p>Diese Seite nutzt des weiteren auch das Tool Circuit Sandbox. Auch hier wird auf eine lokal installierte Version zurückgegriffen und
        keine Verbindung zu anderen Servern hergestellt.</p>
        <p>Weitere Informationen zu Circuit Sandbox finden Sie unter <a href="https://github.com/willymcallister/circuit-sandbox" target="_blank" rel="noopener noreferrer">https://github.com/willymcallister/circuit-sandbox</a></p>
    ...
    backBtn: "Zur&uumlck zur Hauptseite"
}